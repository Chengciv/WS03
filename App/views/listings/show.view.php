...
<section class="container mx-auto p-4 mt-4">
      ...
      <?php if(Framework\Authorization::isOwner($listing->user_id)) : ?> <!-- ✅ Check if user is logged in AND is the owner of the listing --> 
      <div class="flex space-x-4 ml-4">
        <a href="/listings/edit/<?= 
        $listing->id ?>" class="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded">Edit</a>
        <!-- Delete Form -->
        <form method="POST">
